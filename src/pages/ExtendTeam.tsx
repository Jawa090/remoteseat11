    ...
    <div className="space-y-3">
      {faqs.map((faq, index) => (
        <div key={index} className="bg-white rounded-lg border border-gray-200 overflow-hidden">
          ...
          >
            <h3 className="text-lg font-medium text-[#212121] pr-4">
              {faq.question}
            </h3>
            <div className="flex-shrink-0">
              {openIndex === index ? (
                <svg className="w-5 h-5 text-[#C95B4A]" fill="currentColor" viewBox="0 0 20 20">
  ...
  return (
    <div className="relative">
              ...
              <div className={`transition-all duration-300 ${
                ...
                {activeCard === card.id && (
                  <div className="text-center space-y-1 text-sm">
                    ...
                    <div className="text-[#C95B4A] font-semibold text-base">Vs.</div>
      ...
      <div className="flex justify-start mt-6 gap-2">
        <button className="w-10 h-10 rounded-full bg-[#C95B4A] text-white flex items-center justify-center hover:bg-[#B54A39] transition-colors">
...
const ExtendTeam = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="bg-[#212121] py-12 lg:py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            {/* Left Content */}
            <div className="flex flex-col">
              <h1 className="text-3xl lg:text-5xl xl:text-6xl font-semibold text-white leading-tight mb-6">
                Outsource Architecture and Construction Talent with{" "}
                <span className="text-[#C95B4A]">Offshore Staffing</span>
              </h1>
              <p className="text-[#F0F0F0] text-base lg:text-lg leading-relaxed mb-8">
              ...
              <div className="lg:hidden">
                <Link
                  to="/contact-us"
                  className="inline-flex items-center justify-center w-full gap-2 rounded-full bg-[#C95B4A] px-6 py-3 text-white font-medium hover:bg-[#B54A39] transition-colors"
                >
                  <svg
                    aria-hidden="true"
                    className="h-4 w-4"
            ...
            <div className="hidden lg:block">
              <div className="bg-white rounded-[12px] overflow-hidden shadow-[0px_0px_28px_0px_rgba(0,0,0,0.18)] min-w-[320px] h-[500px]">
                <iframe
      ...
      <section className="bg-[#212121] pb-12 lg:pb-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="bg-[#f4f4f4] rounded-[12px] px-6 py-4 shadow-[0px_0px_28px_0px_rgba(0,0,0,0.18)]">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              <h2 className="text-[18px] lg:text-[20px] font-semibold text-[#212121]">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-full bg-[#f7e7e4] px-5 py-2.5 text-sm font-medium text-[#C95B4A] shadow-sm ring-1 ring-black/5 hover:bg-[#f2dad6] transition-colors"
                >
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="lg:w-96">
              <h2 className="text-2xl md:text-3xl font-semibold text-[#212121] mb-6">
                Talk to Our AEC Offshore Staffing Consultants
              </h2>
              <p className="text-[#6b6b6b] text-base mb-8 leading-relaxed">
                68% of top US construction and architecture firms now leverage offshore talent to reduce costs and meet deadlines. At EZYBUILDS, access the top 1% of AEC professionals with direct US project experience. Your competitors are already scaling smarter; don't get left behind.
              </p>
              <Link
                to="/contact-us"
                className="inline-flex items-center justify-center gap-2 rounded-full bg-[#C95B4A] px-8 py-4 text-white font-medium hover:bg-[#B54A39] transition-colors"
              >
                <svg
                  aria-hidden="true"
                  className="h-4 w-4"
      ...
      {/* Our Clients Section */}
      <section 
        className="bg-[#C95B4A] py-20 relative overflow-hidden"
        style={{
          ...
          <div className="hidden lg:grid lg:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-[0px_0px_28px_0px_rgba(0,0,0,0.08)] border border-gray-100 hover:shadow-[0px_0px_28px_0px_rgba(0,0,0,0.15)] transition-shadow">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[#212121]">Construction Designer</h3>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-[0px_0px_28px_0px_rgba(0,0,0,0.08)] border border-gray-100 hover:shadow-[0px_0px_28px_0px_rgba(0,0,0,0.15)] transition-shadow">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[#212121]">Civil<br/>Engineer</h3>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-[0px_0px_28px_0px_rgba(0,0,0,0.08)] border border-gray-100 hover:shadow-[0px_0px_28px_0px_rgba(0,0,0,0.15)] transition-shadow">
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" className="w-12 h-12" fill="#C95B4A">
                    <rect width="256" height="256" fill="none"/>
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[#212121]">Project Accountant</h3>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-[0px_0px_28px_0px_rgba(0,0,0,0.08)] border border-gray-100 hover:shadow-[0px_0px_28px_0px_rgba(0,0,0,0.15)] transition-shadow">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[#212121]">BIM<br/>Specialist</h3>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-[0px_0px_28px_0px_rgba(0,0,0,0.08)] border border-gray-100 hover:shadow-[0px_0px_28px_0px_rgba(0,0,0,0.15)] transition-shadow">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[#212121]">Project<br/>Manager</h3>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-[0px_0px_28px_0px_rgba(0,0,0,0.08)] border border-gray-100 hover:shadow-[0px_0px_28px_0px_rgba(0,0,0,0.15)] transition-shadow">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[#212121]">3D<br/>Visualizer</h3>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-[#373737] py-20 lg:py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row justify-between items-start mb-16">
            {/* Left Content */}
            <div className="lg:w-1/2 mb-6 lg:mb-0">
              <h2 className="text-4xl md:text-5xl font-bold leading-tight text-white">
                Save <span className="text-[#C95B4A]">Up To 70%</span> with Zero Compromise on Quality.
              </h2>
            </div>
          ...
          <div className="lg:hidden space-y-4">
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6 text-white">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="text-center text-[#C95B4A] font-semibold">Vs.</div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between pt-2 border-t border-white/20">
                  ...
                  <span className="font-bold text-[#C95B4A]">~$115,000</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6 text-white">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between pt-2 border-t border-white/20">
                  <span className="text-white/80">Annual Avg. Saving</span>
                  <span className="font-bold text-[#C95B4A]">~$57,000</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6 text-white">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between pt-2 border-t border-white/20">
                  <span className="text-white/80">Annual Avg. Saving</span>
                  <span className="font-bold text-[#C95B4A]">~$74,000</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6 text-white">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between pt-2 border-t border-white/20">
                  <span className="text-white/80">Annual Avg. Saving</span>
                  <span className="font-bold text-[#C95B4A]">~$63,000</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="mb-12">
                <h2 className="text-4xl lg:text-5xl font-bold text-[#212121] mb-4">
                  Build Your Offshore AEC Team in <span className="text-[#C95B4A]">4 STEPS</span>
                </h2>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 bg-[#C95B4A] rounded-full flex items-center justify-center">
                ...
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 bg-[#373737] rounded-full flex items-center justify-center">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="text-center">
                <p className="text-2xl lg:text-3xl font-semibold text-[#212121]">
                  Build your dream team faster with <span className="text-[#C95B4A]">EZYBUILDS</span>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="hidden lg:block">
                <Link
                  to="/contact-us"
                  className="inline-flex items-center justify-center gap-2 rounded-full bg-[#C95B4A] px-8 py-4 text-white font-medium hover:bg-[#B54A39] transition-colors text-lg"
                >
                  <svg
                    aria-hidden="true"
                    className="h-5 w-5"
      ...
      {/* FAQ Section */}
      <section className="bg-gray-100 py-20 lg:py-24 hidden lg:block">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          {/* Section Title */}
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-[#212121]">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <div className="mb-6">
                <h3 className="text-2xl font-bold text-[#212121] mb-2">
                  Call Us <span className="text-[#C95B4A]">Right Now</span>
                </h3>
              ...
              <form className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#C95B4A] focus:border-transparent outline-none"
                    required
                  />
                  <input
                    type="text"
                ...
                {/* State Dropdown */}
                <select className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#C95B4A] focus:border-transparent outline-none text-gray-500">
                ...
                <button
                  type="submit"
                  className="w-full bg-[#C95B4A] text-white py-3 px-6 rounded-lg font-medium hover:bg-[#B54A39] transition-colors"
                >
                  Next Step
                </button>
              </form>
